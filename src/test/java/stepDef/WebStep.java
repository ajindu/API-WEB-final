...
public class WebStep {
    ...
    @Then("user will see text welcome {string}")
    public void userWillSeeTextWelcome(String welcomeMsg) {
        webPage.assertWelcome(welcomeMsg);
    }
    ...
    @And("user click menu {string}")
    public void userClickMenu(String menu) {
        webPage.assertMenu(menu);
    }
